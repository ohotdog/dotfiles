...
dir=~/dotfiles
olddir=~/.dotfiles_old
files="bg bash_profile bashrc gitconfig inputrc vimrc xinitrc Xresources config/i3/config config/conky/config config/dunst/dunstrc config/polybar/config config/polybar/launch.sh config/user-dirs.dirs"
update=false
